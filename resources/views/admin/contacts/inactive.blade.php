...
<script>
    $(function () {
        ...
        $("#table_wrapper").prepend('<a href="/admin/contacts" class="btn btn-primary float-left"><i class="fa-solid fa-envelope"></i> Ver ativos</a>');
            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5 class="m-0">Contatos inativados</h5>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-row">
                                            <div class="mr-2 tool" data-container=".tool" data-toggle="tooltip" data-placement="top" title="Resolvido">
                                                <form action="{{ route('admin.contacts.active', $contact->id) }}" method="post">
                                                    ...
                                                    <button class="btn btn-success btn-sm"><i class="fas fa-arrow-up"></i></button>
                                                </form>
                                            </div>
