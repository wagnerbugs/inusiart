...
<script>
    $(function () {
        ...
        $("#table_wrapper").prepend('<a href="/admin/categories/create" class="btn btn-primary float-left"><i class="fa-solid fa-th"></i> Adicionar</a>');
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Categorias dos produtos</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5 class="m-0">Categorias cadastradas</h5>
                    </div>
                    <div class="card-body">
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="d-flex flex-row">
                                            ...
                                            <div class="mr-2 tool" data-container=".tool" data-toggle="tooltip" data-placement="top" title="Excluir">
                                                <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-delete" data-id="{{ $category->id }}">
