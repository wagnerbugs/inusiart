                ...
                <div class="row no-gutters">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-slider-active owl-carousel">
                            <a class="img-popup" href="{{ url('storage/images/product/quickview-1.jpg') }}">
                                <img src="{{ url('storage/images/product/quickview-1.jpg') }}" alt="">
                            </a>
                            <a class="img-popup" href="{{ url('storage/images/product/quickview-2.jpg') }}">
                                <img src="{{ url('storage/images/product/quickview-2.jpg') }}" alt="">
                            </a>
                        </div>
